...
func (r *GatewayReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	activeEps := r.electActiveEndpoints(nodeList, &gw)
	if len(activeEps) == 0 {
...
func (r *GatewayReconciler) electActiveEndpoints(nodeList corev1.NodeList, gw *ravenv1alpha1.Gateway) []*ravenv1alpha1.ActiveEndpoint {
